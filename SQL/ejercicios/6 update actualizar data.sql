...
/*
Modifique los registros cuyo autor sea igual  a "Paenza", por 
...
/*
Nuevamente, modifique los registros cuyo autor sea igual  a "Paenza",
por "Adrian Paenza" (ningún registro afectado porque ninguno cumple 
la condición)
*/
...
/*
Actualice el precio del libro de "Mario Molina" 
a 27 pesos (1 registro afectado):
*/
update libros set precio = 27
	where autor = 'Mario Molina';
select * from libros;
...
/*
Actualice el valor del campo "editorial" por "Emece S.A.", 
para todos los registros cuya editorial sea igual a "Emece" 
